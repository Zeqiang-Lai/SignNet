...
if __name__ == "__main__":
    ...
    out = cv2.VideoWriter('mask.mp4', cv2.VideoWriter_fourcc(*'MP4V'), 25, (200, 200), 0)
    out2 = cv2.VideoWriter('origin.mp4', cv2.VideoWriter_fourcc(*'MP4V'), 25, (200, 200), 0)
